...
| 008 | [RuView](projects/008-ruview/README.md) | 分析多径叠加后的 CSI 变化推断活动；真实人体演示依赖 CSI 硬件、匹配算法与现场验证；借鉴信号→事件→联动，扩展日常蓝牙和手机感知 | [ruvnet/RuView](https://github.com/ruvnet/RuView) | 理解已总结；人体效果未验证 | [在线研究汇总](https://yydshly.github.io/0912_codex_project/008-ruview/) · [本地测试](projects/008-ruview/real-wifi/README.md) |
...
### 008 · [RuView](projects/008-ruview/README.md)

**原理：人体改变 Wi-Fi 传播路径，多路信号先在接收端叠加，CSI 记录各频点的幅度与相位，算法再分析其时间变化并推断活动。** 不必先给每条反射波定位再汇总；姿态等复杂任务还依赖训练模型。
...
另有[在线研究汇总网页](https://yydshly.github.io/0912_codex_project/008-ruview/)，关联原理、依赖、价值与本地实验说明；已于 2026-09-13 通过 GitHub Pages 发布并实际打开核验。在线页提供研究阅读，本机监测、算法实验和虚拟房间各自保留原入口。[网页运行与发布记录](projects/008-ruview/web/README.md#研究汇总网页)。

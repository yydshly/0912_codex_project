...
本子项目通过可操作的「欧姆定律互动课堂」、原创能力图、官方示例和固定源码分析展示该库。课堂课件真实接入官方渲染组件，其他互动为案例实现。**官方素材是上游展示；角色对话是预设脚本，尚未配置模型服务或实测完整生成流程。** [在线研究与能力展示](https://yydshly.github.io/0912_codex_project/005-openmaic/) · [进入互动课堂](https://yydshly.github.io/0912_codex_project/005-openmaic/case.html) · [八环节体验路线](notes/05-case-study.md)
...
研究网页另有**六能力生成与执行实验台**：查看输入要求，修改 JSON 或实验网页代码，逐条执行并观察课件、白板、实验、对话、测验和任务状态。支持下载示例产物与能力提取说明；生成阶段使用本地模板，执行阶段使用真实组件或明确标注的简化程序。[实验台运行与提取说明](web/README.md)

## 新读者引导：内容如何变成网页效果

![六能力引导：课件、白板、实验、对话、测验与任务各自生成什么，以及网页如何呈现和执行](assets/six-capabilities-web-guide.png)

**网页是承载环境，幻灯片是其中一页课件的组织方式。** 课件 JSON 由组件解释后成为网页中的幻灯片；实验生成网页代码；其他模块依靠指令、表单、对话和状态界面呈现。上图为新增概念引导，原有能力全景图与详细原理图继续保留。[六能力说明与全部网页导航](notes/08-web-guide.md) · [图片来源](assets/README.md)
...
| 本研究 Web 演示 | [GitHub Pages 在线展示](https://yydshly.github.io/0912_codex_project/005-openmaic/)；2026-09-11 发布并核验，[运行与发布说明](web/README.md) |
...
- [六能力引导与全部网页导航](notes/08-web-guide.md)
